...
public class Game implements ActionListener, MouseListener {
	...
	private JMenuBar menubar2; // menu bar
	private JMenu fileMenu; // main menu that holds other options
	private JMenu gameMenu; // main menu that holds other options
	...
	public void playGame() { 
		...
		newGame = new JMenuItem("New Window");
		newGame.addActionListener(this); 
		exitGame = new JMenuItem("Quit Window");
